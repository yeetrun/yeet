...
func TestWriteVMGuestMetadataFiles(t *testing.T) {
	...
	assertFileContains(t, filepath.Join(root, "etc", "systemd", "system", "yeet-guest-ready.service"), "guest-ready")
	assertFileContains(t, filepath.Join(root, "usr", "local", "lib", "yeet-vm", "guest-ready"), "yeet-ip")
