...
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet run "$TEST_VM" vm://nixos/26.05 --image-policy=cached --net=svc --service-root="flash/yeet/vms/${TEST_VM}" --zfs
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet vm snapshot "$TEST_VM" --comment "codex recovery smoke"
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet snapshots list "$TEST_VM"
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet snapshots clone "$TEST_VM" <snapshot-short-name> "$TEST_VM_CLONE"
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet info "$TEST_VM_CLONE"
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet snapshots restore "$TEST_VM" <snapshot-short-name> --stop --yes
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet remove "$TEST_VM_CLONE" --yes --clean-data --clean-config
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet remove "$TEST_VM" --yes --clean-data --clean-config
```
...
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet run "$TEST_SVC" ./bin/helloworld --service-root="flash/yeet/${TEST_SVC}" --zfs --snapshots=on
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet snapshots create "$TEST_SVC" --comment "codex service-root smoke"
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet snapshots list "$TEST_SVC"
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet snapshots clone "$TEST_SVC" <snapshot-short-name> "$TEST_SVC_CLONE"
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet info "$TEST_SVC_CLONE"
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet snapshots restore "$TEST_SVC" <snapshot-short-name> --stop --yes
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet remove "$TEST_SVC_CLONE" --yes --clean-data --clean-config
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet remove "$TEST_SVC" --yes --clean-data --clean-config
```
...
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet run "$TEST_FULL_VM" vm://nixos/26.05 --image-policy=cached --net=svc --service-root="flash/yeet/vms/${TEST_FULL_VM}" --zfs
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet snapshots create "$TEST_FULL_VM" --full --comment "codex full checkpoint smoke"
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet snapshots restore "$TEST_FULL_VM" <snapshot-short-name> --mode=full --stop --yes
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet remove "$TEST_FULL_VM" --yes --clean-data --clean-config
```
...
export TEST_FULL_VM="codex-vm-full-$(date +%Y%m%d%H%M%S)"
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet run "$TEST_FULL_VM" vm://nixos/26.05 --image-policy=cached --net=svc --service-root="flash/yeet/vms/${TEST_FULL_VM}" --zfs
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet snapshots create "$TEST_FULL_VM" --full --comment "codex full checkpoint refusal smoke"
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet snapshots restore "$TEST_FULL_VM" <snapshot-short-name> --mode=full --stop --yes
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet snapshots restore "$TEST_FULL_VM" <snapshot-short-name> --mode=disk --stop --yes
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet remove "$TEST_FULL_VM" --yes --clean-data --clean-config
```
