...
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet run lanbridge-smoke-pve1 vm://ubuntu/26.04 --net=lan --image-policy=cached
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet status
CATCH_HOST=yeet-pve1 mise exec -- go run ./cmd/yeet rm lanbridge-smoke-pve1 --yes --clean
```
