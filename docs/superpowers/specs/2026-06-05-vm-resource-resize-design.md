...
Use a disposable VM on pve1:

```bash
yeet run trash-vm@yeet-pve1 vm://ubuntu/26.04 --service-root=flash/yeet/vms/trash-vm --zfs --disk=8g --net=svc
yeet stop trash-vm@yeet-pve1
yeet service set trash-vm@yeet-pve1 --cpus=2 --memory=2g --disk=16g
yeet start trash-vm@yeet-pve1
yeet info trash-vm@yeet-pve1
yeet ssh trash-vm@yeet-pve1 -- df -h /
yeet stop trash-vm@yeet-pve1
yeet service set trash-vm@yeet-pve1 --net=lan
yeet start trash-vm@yeet-pve1
yeet info trash-vm@yeet-pve1
yeet rm trash-vm@yeet-pve1 --clean-data --clean-config
```
...
- Unit tests and live pve1 verification pass.
