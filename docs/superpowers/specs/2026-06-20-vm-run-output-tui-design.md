...
```text
action=run service=hermes@yeet-pve1 status=running step="Wait for guest readiness"
action=run service=hermes@yeet-pve1 status=ok step="Wait for guest readiness" detail=10.0.4.200
action=run service=hermes@yeet-pve1 status=info detail="SSH yeet ssh hermes"
action=run service=hermes@yeet-pve1 status=info detail="Console yeet vm console hermes"
```
