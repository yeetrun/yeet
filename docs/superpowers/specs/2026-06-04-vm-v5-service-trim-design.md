...
Execution note: live v5 testing on `lab-host` validated the service trim and
...
The v4 live measurement on `lab-host` reached:
...
After the v5 GitHub image workflow succeeds and live `lab-host` validation passes,
